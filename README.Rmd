...
Lexicons thats how, here are 5 randomly sampled words from four popular lexicons and then ours. Here is where we can add a whole bunch of text. I will use a bunch of the options to really help you see how well this works. ^[Noop norp zorp]
...
knitr::kable(
  B1[1:2, 1:2], caption = 'A subset of our system.'
)
